function btnAnadirManifiesto()
{
  ...
  if(imagen_manifiesto == '')
  {
    $('#imagen_manifiesto').removeClass("input-registro-ok"); //Quitamos la clase del input relleno
    $('#imagen_manifiesto').addClass("input-registro-vacio"); //Añadimos clase de input vacio
    vacio = true;
  }
  else
  {
    $('#imagen_manifiesto').addClass("input-registro-ok"); //Añadimos la clase del input relleno
  }
